  ...
  >
    ...
    >
      <AppCloseBar
        ...
        button-label="Close overlay indicating that the discount has been set."
        @close="emit('close')"
      />
      ...
      <div class="relative flex-grow flex flex-col items-center justify-center gap-5 p-5 text-2xl z-10 sm:p-8 sm:gap-8">
