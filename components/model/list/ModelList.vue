<template>
  <div class="model-list flex flex-col justify-center items-center gap-16 p-16 text-whiteishMain bg-blackishDark  md:relative md:h-[100svh] xl:h-[Calc(100svh_-_var(--nav-height)] md:w-full md:bg-whiteishMain">
    <div
