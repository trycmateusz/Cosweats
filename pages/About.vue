<template>
  <div class="text-center">
    <header class="flex flex-col justify-center items-center gap-16 p-8 min-h-[100svh] text-blackishMain">
      ...
      <AppArrow class="header-arrow" anchor="#content"></AppArrow>
    </header>
    <header id="content" class="flex flex-col justify-center items-center p-16 min-h-[100svh] bg-whiteishPink font-halibutSerifRegular">
      <h2 class="wrapper flex flex-col uppercase text-5xl sm:text-6xl md:text-7xl text-pinkDark">
        we are presenting
    ...
    <section class="text-center text-blackishMain">
      ...
      <div class="occupations flex flex-col gap-8 sm:gap-0">
        <div class="ceo wrapper p-16  flex gap-8 relative">
          <img src="ceo.svg" alt="A picture of Cosweats CEO - Aisha" class="hidden sm:block max-w-[40%] max-h-[320px] md:max-h-[400px] 2xl:max-h-[500px]">
        ...
        <div class="designer wrapper p-16  flex gap-8 relative mb-16">
          ...
          <img src="designer.svg" alt="A picture of Cosweats Lead Designer - Sarah" class="hidden sm:block max-w-[40%] max-h-[320px] md:max-h-[400px] 2xl:max-h-[500px]">
