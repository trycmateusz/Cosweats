<template>
  <main class="text-center">
    ...
    <header class="flex flex-col justify-center items-center gap-16 p-8 min-h-[Calc(100vh_-_6.25rem)] text-blackishMain overflow-hidden">
    ...
    <header id="content" class="flex flex-col justify-center items-center p-16 min-h-[Calc(100svh_-_6.25rem)] bg-whiteishPink font-halibutSerifRegular">
    ...
    <section class="text-center text-blackishMain">
      ...
      <div class="occupations flex flex-col gap-8 sm:gap-0">
        <div class="ceo wrapper p-16  flex gap-8 relative">
          <img src="~/assets/img/ceo.svg" alt="A picture of Cosweats CEO - Aisha" class="hidden sm:block max-w-[40%] max-h-[320px] md:max-h-[400px] xl:max-h-[80svh]">
        ...
        <div class="designer wrapper p-16  flex gap-8 relative mb-16">
          ...
          <img src="~/assets/img/designer.svg" alt="A picture of Cosweats Lead Designer - Sarah" class="hidden sm:block max-w-[40%] max-h-[320px] md:max-h-[400px] xl:max-h-[80svh]">
